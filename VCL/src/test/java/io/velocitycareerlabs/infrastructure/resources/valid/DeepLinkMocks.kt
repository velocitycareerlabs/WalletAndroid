...
class DeepLinkMocks {
    companion object {
        ...
        const val PresentationRequestDeepLinkStr =
            "velocity-network://inspect?request_uri=$PresentationRequestRequestUriStr"

        val PresentationRequestDeepLink = VCLDeepLink(value = PresentationRequestDeepLinkStr)
        ...
        const val CredentialManifestDeepLinkStr = "velocity-network://issue?request_uri=$CredentialManifestRequestUriStr"

        val CredentialManifestDeepLink = VCLDeepLink(value = CredentialManifestDeepLinkStr)
