...
class DeepLinkMocks {
    companion object {
        ...
        const val InspectorDidEncoded = "did%3Avelocity%3A0xd4df29726d500f9b85bc6c7f1b3c021f16305692"
        ...
        const val PresentationRequestVendorOriginContextEncoded =
            "%7B%22SubjectKey%22%3A%7B%22BusinessUnit%22%3A%22ZC%22%2C%22KeyCode%22%3A%2254514480%22%7D%2C%22Token%22%3A%22832077a4%22%7D"
        ...
        const val PresentationRequestRequestUriStr =
            "https%3A%2F%2Fagent.velocitycareerlabs.io%2Fapi%2Fholder%2Fv0.6%2Forg%2Fdid%3Avelocity%3A0xd4df29726d500f9b85bc6c7f1b3c021f16305692%2Finspect%2Fget-presentation-request%3Fid%3D62e0e80c5ebfe73230b0becc"
        const val PresentationRequestRequestUriWithIdStr =
            "https%3A%2F%2Fagent.velocitycareerlabs.io%2Fapi%2Fholder%2Fv0.6%2Forg%2F$InspectorId%2Finspect%2Fget-presentation-request%3Fid%3D62e0e80c5ebfe73230b0becc"

        const val PresentationRequestDeepLinkDevNetStr =
            "$DevNetProtocol://inspect?request_uri=$PresentationRequestRequestUriStr&inspectorDid=$InspectorDidEncoded&vendorOriginContext=$PresentationRequestVendorOriginContextEncoded"
        const val PresentationRequestDeepLinkTestNetStr =
            "$TestNetProtocol://inspect?request_uri=$PresentationRequestRequestUriStr&inspectorDid=$InspectorDidEncoded&vendorOriginContext=$PresentationRequestVendorOriginContextEncoded"
        const val PresentationRequestDeepLinkMainNetStr =
            "$MainNetProtocol://inspect?request_uri=$PresentationRequestRequestUriStr&inspectorDid=$InspectorDidEncoded&vendorOriginContext=$PresentationRequestVendorOriginContextEncoded"
        const val PresentationRequestDeepLinkMainNetWithIdStr =
            "$MainNetProtocol://inspect?request_uri=$PresentationRequestRequestUriWithIdStr&inspectorDid=$InspectorDidEncoded&vendorOriginContext=$PresentationRequestVendorOriginContextEncoded"

        const val IssuerDid = "did:ion:EiApMLdMb4NPb8sae9-hXGHP79W1gisApVSE80USPEbtJA"
        const val IssuerDidEncoded = "did%3Aion%3AEiApMLdMb4NPb8sae9-hXGHP79W1gisApVSE80USPEbtJA"
        ...
        const val CredentialManifestRequestUriStr =
            "https%3A%2F%2Fdevagent.velocitycareerlabs.io%2Fapi%2Fholder%2Fv0.6%2Forg%2Fdid%3Aion%3AEiApMLdMb4NPb8sae9-hXGHP79W1gisApVSE80USPEbtJA%2Fissue%2Fget-credential-manifest%3Fid%3D611b5836e93d08000af6f1bc%26credential_types%3DPastEmploymentPosition"
        const val CredentialManifestRequestUriWithIdStr =
            "https%3A%2F%2Fdevagent.velocitycareerlabs.io%2Fapi%2Fholder%2Fv0.6%2Forg%2F$IssuerId%2Fissue%2Fget-credential-manifest%3Fid%3D611b5836e93d08000af6f1bc%26credential_types%3DPastEmploymentPosition"

        const val CredentialManifestDeepLinkDevNetStr = "$DevNetProtocol://issue?request_uri=$CredentialManifestRequestUriStr&issuerDid=$IssuerDidEncoded"
        const val CredentialManifestDeepLinkTestNetStr = "$TestNetProtocol://issue?request_uri=$CredentialManifestRequestUriStr&issuerDid=$IssuerDidEncoded"
        const val CredentialManifestDeepLinkMainNetStr = "$MainNetProtocol://issue?request_uri=$CredentialManifestRequestUriStr&issuerDid=$IssuerDidEncoded"
        const val CredentialManifestDeepLinkMainNetWithIdStr = "$MainNetProtocol://issue?request_uri=$CredentialManifestRequestUriWithIdStr&issuerDid=$IssuerDidEncoded"
